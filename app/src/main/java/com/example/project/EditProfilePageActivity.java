                    ...
                    public void onSuccess(Void aVoid) {
                        user.updatePassword(newp)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        pd.dismiss();
                                        Toast.makeText(EditProfilePageActivity.this, "Changed Password", Toast.LENGTH_LONG).show();
                                    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    if (key.equals("name")) {
                        ...
                        Query query = databaser.orderByValue();
                        query.addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                    if(dataSnapshot1.child("uid").getValue().equals(firebaseUser.getUid())) {
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        storageReference1.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                System.out.println("url "+downloadUri.toString());;
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(EditProfilePageActivity.this, "Error1", Toast.LENGTH_LONG).show();
            }
        });
    }
    @Override
