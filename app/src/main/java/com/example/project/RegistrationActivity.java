...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void registerUser(String emaill, String pass, String uname) {
        progressDialog.show();
        mAuth.createUserWithEmailAndPassword(emaill, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    hashMap.put("image", "https://firebasestorage.googleapis.com/v0/b/project-49c1e.appspot.com/o/Users_Profile_Cover_image%2Fimage_27Ekvv3Lk0eiNbcf4tVP17I279j2?alt=media&token=3839adfb-1797-48a2-83ee-ddeb08f43b69");
