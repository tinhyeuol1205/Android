...
import com.example.project.model.ModelComment;

import java.util.Calendar;
import java.util.List;
import java.util.Locale;

public class AdapterComment extends RecyclerView.Adapter<com.example.project.adapter.AdapterComment.MyHolder> {
